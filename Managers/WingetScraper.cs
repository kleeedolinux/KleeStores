...
{
    public class WingetScraper
    {
        private readonly string _baseApiUrl = "https://kleestoreapi.vercel.app/api/winget/packages";
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    apiUrl = $"{_baseApiUrl}?page={page}&limit={limit}";
                }
                ...
                if (apiResponse != null && apiResponse.Packages != null)
                {
                    foreach (var apiPackage in apiResponse.Packages)
                    {
                        var package = new Package
                        {
                            ...
                            Publisher = apiPackage.Publisher,
